...
public class BugReportFilter implements Filter{
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        if (session == null || session.getAttribute("user") == null) {
            ...
            if(!session.getAttribute("job_position").equals("Inventory Officer") || session.getAttribute("job_position").equals("Vice President") || session.getAttribute("account_type").equals("client")){
